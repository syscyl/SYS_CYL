            ...
            <div class="row">              
                ...
                <div class="col-xs-3" hidden>
                    <form action="return false" onsubmit="return false" id="form-codenvio">
                       <blockquote><label>CÓDIGO DE ENVIO:&nbsp;&nbsp;</label><input type="text" id="txt-codenvio" value="<?=$guia;?>" />
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <table id="table-envio-estado" class="table table-bordered">
                                <thead>
                                    <tr>                                        
                                        <th>Nº DE ENTREGA</th>                      
                                        <th style="display:none;">DESTINO</th>                      
                                        <th>ESTADO ACTUAL</th>   
                                    </tr>
                                </thead> 
                                <tbody>              
...
<!-- <div class="modal fade" id="modal-foto-crono">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 align="center" class="modal-title"><b>CRONOGRAMA</b></h4>
                <div style="text-align: center;margin-top: 10px;"></div>
            </div>
            <div class="modal-body" id="img-foto-crono">                    
            </div>
        </div>
    </div>
</div> -->
