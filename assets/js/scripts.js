        ...
        if ($.isFunction($.fn.daterangepicker)) {
            $(".daterange").each(function(i, e) {
                ...
                var ranges = {
                    ...
                    'Actual Mes': [moment().startOf('month'), moment().endOf('month')],
                    'Anterior Mes': [moment().subtract('month', 1).startOf('month'), moment().subtract('month', 1).endOf('month')]
                };
...
//                        $this.find('span').html(start.format(drp.format) + drp.separator + end.format(drp.format));
                        $this.find('span').html(start.format('DD/MM/YYYY') + ' - ' + end.format('DD/MM/YYYY'));
                    }
                });
